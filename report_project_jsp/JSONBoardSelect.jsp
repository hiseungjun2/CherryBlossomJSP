...
<%
   ...
   try{
      ...
      pstmt=conn.prepareStatement("SELECT * from reportProject_board");
      ...
      while(rs.next())
      {
         ...
         jObject.put("id", rs.getInt("board_id"));
         jObject.put("title", rs.getString("board_title"));
         jObject.put("date", rs.getString("board_date"));
         jObject.put("userid", rs.getString("user_id"));
         jObject.put("username", rs.getString("user_name"));
         jObject.put("map", rs.getString("board_map"));
         jObject.put("content", rs.getString("board_content"));
